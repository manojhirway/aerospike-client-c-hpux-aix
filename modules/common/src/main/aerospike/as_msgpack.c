...
static inline uint16_t as_extract_uint16(as_unpacker * pk)
{
	uint16_t v;
#ifndef __hpux
	v = *(uint16_t*)(pk->buffer + pk->offset);
#else
	memcpy(&v,(uint16_t*)(pk->buffer + pk->offset),sizeof(uint16_t));
#endif
...
static inline uint32_t as_extract_uint32(as_unpacker * pk)
{
        uint32_t v;
#ifndef __hpux
        v = *(uint32_t*)(pk->buffer + pk->offset);
#else
        memcpy(&v,(uint32_t*)(pk->buffer + pk->offset),sizeof(uint32_t));
#endif
...
static inline uint64_t as_extract_uint64(as_unpacker * pk)
{
	uint64_t v;
#ifndef __hpux
        v = *(uint64_t*)(pk->buffer + pk->offset);
#else
        memcpy(&v,(uint64_t*)(pk->buffer + pk->offset),sizeof(uint64_t));
#endif
